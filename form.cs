    ...
    public partial class Form1 : Form
    {
        ...
        private void createBTN()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    xbutton[i, j] = new Button();
                    xbutton[i, j].Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
                    xbutton[i, j].Click += new EventHandler(button1_Click);
                    tableLayoutPanel1.Controls.Add(xbutton[i, j], i, j);
